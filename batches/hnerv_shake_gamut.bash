...
data="/scratch/kl3866/IVP/HNeRV/data/uvg_10bit/ShakeNDry_3840x2160_120fps_420_10bit_YUV_960x540_downsampled_images/"
outpath="/scratch/kl3866/IVP/HNeRV/shake_hnerv"
qt_model=(4 8 16 32)
qt_embed=(2 6 12 18)
        ...
        do
            ...
            #             do
                        ...
                        python ../run_hnerv.py --data_path ${data} \
                                              --batchSize 32 \
                                              --vid shake_sbatch_test_${qtm}_${qte} \
                                              --outf shake_sbatch_test_out_${qtm}_${qte} \
