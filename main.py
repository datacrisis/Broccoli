...
def main():
    ...
    parser.add_argument('--compression_method', default='huffman', help="Type of compression method to use to compress embeddings and model")
...
def evaluate(model, full_dataloader, local_rank, args, 
    dump_vis=False, compression_method=None):
