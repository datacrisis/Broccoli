...
data="/scratch/kl3866/IVP/HNeRV/data/uvg_10bit/ReadySetGo_3840x2160_120fps_420_10bit_YUV_960x540_downsampled_images"
outpath="/scratch/kl3866/IVP/HNeRV/ready_hnerv"
qt_model=(4 8 16 32)
qt_embed=(2 6 12 18)
        ...
        do
            ...
            #             do
                        ...
                        python ../run_hnerv.py --data_path ${data} \
                                              --batchSize 32 \
                                              --vid ready_sbatch_test_${qtm}_${qte} \
                                              --outf ready_sbatch_test_out_${qtm}_${qte} \
